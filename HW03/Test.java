...
public class Test{
   ...
   public static void symmetricSetDifference(Set<Integer> first, Set<Integer> second){
      ...
      fake1.removeAll(second);
      fake2.removeAll(first);
      
      improved.addAll(fake1);
      ...
      if (original.size() == 0){
         System.out.println(0);
          ...
          int max = Collections.max(improved.values());
            ...
            ArrayList<Integer> list = new ArrayList<>(improved.keySet());
            ...
            System.out.println("Key: "+legit.get(max)+" , Occurences: "+ max);
         }
   }
}